...
const { generateWAMessageFromContent, generateForwardMessageContent, generateWAMessage } = require('@whiskeysockets/baileys')
...
class Message extends Base {
 ...
 async sendMessage(jid, content, opt = { packname: 'Xasena', author: 'X-electra', fileName: 'fx-bot' }, type = 'text') {
