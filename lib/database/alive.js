...
const Alive = new mongoose.Schema({
  id: { type: String,  unique: true ,required: true, default:"fx_bot"},
  ...
  url: { type: String, default:""},image: { type: Boolean, default: false },video: { type: Boolean, default: false },permit:{type:Boolean, default:false},values:{type:String,default:'all'} });
