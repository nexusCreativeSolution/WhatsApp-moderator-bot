...
const sᴜʜᴀɪʟ_ᴍᴅ = require('../lib/commands')
     ...
     smd({
        name: "onlyadmin",
        alias:["antimessge"],
        info: "Only Admins Allow to Send Message, Others kick.",
        type: "group",
        filename: __filename
    },
...
smd({
    name: "antibot",
    info: "kick Bot Users from Group!",
    type: "group",
    filename: __filename
},
async(Suhail, msg, text , { cmdName ,isCreator}) => {
...
smd({
        name: "support",
        info: "Sends official support group link.",
        type: "group",
...
async(Suhail, msg, text,{ isCreator }) => {
    ...
    smd({
        name: "antifake",
        info: "Allow to Join Group For Specific Country Code",
        type: "group",
...
smd({
        name: "antidemote",
        info: "Detects Promote and Automaticaly demote promoted person.", 
        type: "group",
    ...
    smd({
        name: "pdm",
        info: "Detect Promote/Demote Users And Send Alerts in Chat ",
        type: "group",
    ...
    smd({
    name: "common",
    info: "Get common participants in two groups, and kick using .common kick, jid",
    type: "owner",
...
smd({
    name: "diff",
    info: "Get difference of participants in two groups",
    type: "owner",
...
smd({
            name: "unblock",
            info: "Unblocked to the quoted user.",
            type: "owner",
...
return msg.reply("*_Group Link Revoked SuccesFully_*");
    ...
    smd({
        name: "jid",
        info: "get jid of all user in a group.",
        type: "owner",
...
//---------------------------------------------------------------------------
    smd({
        name: "tagall",
        info: "Tags every person of group.",
        type: "group",
...
`
    ...
    smd({
        name: "kik",
        info: "Kick all numbers from a certain country",
        type: "group",
...
smd({
        name: "num",
        info: "get all numbers from a certain country",
        type: "group",
...
smd({
            name: "request",
            info: "Sends requst to main Bot developer.",
            type: "group",
...
smd({
            name: "retrive",
	    alias: ["vv"],
            info: "Copies and Forwords viewonce message.",
            type: "group",
    ...
    smd({
            name: "resetwarn",
            info: "Deletes all previously given warns to quoted user.",
            type: "group",
...
\n\n`
    ...
    smd({
            name: "promote",
            info: "Provides admin role to replied/quoted user",
            type: "group",
    ...
    smd({
    name: "demote",
    info: "Demotes replied/quoted user from group",
    type: "group",
...
smd({
            name: "kick",
            info: "Kicks replied/quoted user from group.",
            type: "group",
...
`)
    ...
    smd({
            name: "gpp",
	    alias:['grouppic'],
            info: "Sets a profile pic in Group..",
            type: "group",
...
return await Suhail.bot.sendMessage(msg.chat,{text : tag ,mentions: [msg.sender, ...groupAdmins.map(v => v.id) ,]} ,)
    ...
    smd({
            name: "getjids",
            alias:['gjid','gjids'],
            info: "Sends chat id of every groups.",
            type: "group",
...
smd({
            name: "del",
            alias: ["delete" , "dlt"],
            info: "Deletes message of any user",
            type: "group",
    ...
    smd({
        name: "broadcast",
        info: "Bot makes a broadcast in all groups",
        fromMe: true,
        type: "group",
